...
# Download message-flow-1.0.0.jar
...
if [ ! -f "message-flow-1.0.0.jar" ]; then
    echo "Failed to download message-flow-1.0.0.jar"
    exit 1
fi

# Install message-flow-1.0.0.jar
...
# Download expressions-1.0.0.jar
...
# Check if the file was downloaded
if [ ! -f "expressions-1.0.0.jar" ]; then
    echo "Failed to download expressions-1.0.0.jar"
    exit 1
fi

# Install expressions-1.0.0.jar
mvn install:install-file \
